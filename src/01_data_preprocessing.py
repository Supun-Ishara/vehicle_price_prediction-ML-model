...
# # Cap outliers using winsorisation (rather than removing rows)
...
# # Log-transform price (normalises skewed distribution)
...
# print("Created: mileage_per_year")
...
# # Also save raw cleaned data for plotting
...
# fuel_colors = {'Petrol': '#e74c3c', 'Hybrid': '#2ecc71', 'Diesel': '#3498db',
#                'Electric': '#9b59b6'}
...
#             'vehicle_age', 'mileage_per_year', 'price_per_km',
...
# df['condition'].value_counts().plot(kind='bar', ax=axes[1], color=['#2ecc71', '#f39c12', '#9b59b6'], edgecolor='white')
